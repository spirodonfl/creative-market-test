...
<body>
    ...
    <div class="container mx-auto p-4 border-2 border-solid border-gray-400 rounded">
        <div id="success">
        <!-- Success message -->
        ...
        <form action="" method="post" action="{{ route('application.store') }}">
            ...
            <div id="step_one">
                ...
                <div class="flex mb-4">
                    <div class="form-group w-1/2 mr-4">
                        ...
                        <input type="text" class="form-control w-full border-2 border-solid border-gray-400 rounded" name="first_name" id="first_name">
                    ...
                    <div class="form-group w-1/2">
                        ...
                        <input type="text" class="form-control w-full border-2 border-solid border-gray-400 rounded" name="last_name" id="last_name">
                ...
                <div class="form-group mb-4">
                    ...
                    <select class="form-control w-full border-2 border-solid border-gray-400 rounded" name="category" id="category">
                ...
                <div class="form-group mb-4">
                    ...
                    <textarea class="form-control w-full border-2 border-solid border-gray-400 rounded" name="portfolio_link" id="portfolio_link"></textarea>
            ...
            <div id="step_two">
                ...
                <div class="form-group mb-4">
                    ...
                    <select class="form-control w-full border-2 border-solid border-gray-400 rounded" name="answer_quality" id="answer_quality">
                ...
                <div class="form-group mb-4">
                    ...
                    <select class="form-control w-full border-2 border-solid border-gray-400 rounded" name="answer_experience" id="answer_experience">
                        <option value="" disabled selected>Select Answer</option>
                ...
                <div class="form-group mb-4">
                    ...
                    <select class="form-control w-full border-2 border-solid border-gray-400 rounded" name="answer_understanding" id="answer_understanding">
                        <option value="" disabled selected>Select Answer</option>
                ...
                <div class="flex">
                    <div class="w-1/2">
                        <input type="button" name="back_form" id="back_form" value="Back" class="btn p-2 border-2 border-solid border-gray-400 rounded">
                    </div>
